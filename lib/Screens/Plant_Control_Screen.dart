...
//     if (mounted) {
//       if (success) {
//         await _fetchMoistureData(); // sync plants
//
//         setState(() {
...
//           _isMasterOn = !value; // revert
//         });
//
//         Timer(const Duration(seconds: 3), () {
//           if (mounted) {
//             setState(() => _allMotorsError = false);
//           }
//         });
//       }
//     }
...
//                           ),
//                           Text(
//                             _allMotorsError ? "CONNECTION FAILED" : (_isMasterOn ? "Stop All Motors" : "Start All Motors"),
